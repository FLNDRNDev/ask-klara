      ...
      <header className={`header ${className}`}>
         <Link href='/' className='flex items-center gap-4'>
            ...
            <Image 
               ...
               width={40} 
               height={40} 
               alt='ask Klara brand icon'
               className="w-[45px] sm:w-[70px]"
            />

            <div className="-space-y-1">
               <h1 className="font-bold text-[14px]">
                  ask <span className="font-thin text-4xl">Klara</span>
               </h1>
               <h2 className='tagline text-xs sm:text-[12px] font-thin'>{t('component.header.subtitle')}</h2>
            </div>
         </Link>
